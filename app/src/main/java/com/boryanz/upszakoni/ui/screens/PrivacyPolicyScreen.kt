...
private val privacyPolictyText =
    "Оваа апликација не собира ниту обработува лични податоци на корисниците, како што се име, адреса или телефонски број. Апликацијата не пристапува ниту користи физичка локација на корисниците, а сите податоци што се користат се строго статички, јавно достапни информации кои можат да се најдат од секој. Содржината не е поврзана со никаква владина институција или официјални органи.\n" +
            ...
            "\n" +
            "Вашата приватност е важна за нас и сите податоци што се прикажуваат се ограничени само на информациите потребни за функционалноста на апликацијата. Оваа апликација е развиена доброволно, со цел да им помогне на лица кој се сппроведувачи на законот."