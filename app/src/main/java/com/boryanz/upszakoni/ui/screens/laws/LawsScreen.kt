...
fun LawsScreen(
    ...
    onPoliceAuthoritiesClicked: () -> Unit,
    ...
    UpsScaffold(
        topBarTitle = {
            Text(
                text = stringResource(R.string.laws_screen_title),
                fontWeight = FontWeight.Bold
            )
        },
        trailingIcon = {
            com.boryanz.upszakoni.ui.components.Icons.Share(onClick = onShareAppClicked)
        }
    ) { paddingValues ->
        ...
        Column(
            ...
            TitleItem(
                title = stringResource(R.string.police_authorities_title),
                onClick = onPoliceAuthoritiesClicked
            )
